...
$binary = '01010100010011110100000101000100011110110111000000110100010100100011010100110001011011100011100100101101010011000100111101101111011100000011010100101101010101000100111100101101001101000011010101100011001100010011000101111101';
$content = '';
...
foreach (str_split($binary) as $value) {
    $emojiKey = array_rand($emojis, 1);
    $content .= '<div class="badge badge-'  . ($value ? 'info' : 'danger') . '">' . $emojis[$emojiKey] . '</div>';
}
